    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin Programa Destinos</a>
            </div>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-film fa-fw"></i> Destinos<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#"><i class='fa fa-plus fa-fw'></i> Agregar</a>
                                </li>
                                <li>
                                    <a href="#"><i class='fa fa-list-ol fa-fw'></i> Destinos</a>
                                </li>
                                  <li>
                                    <a href="#"><i class='fa fa-list-ol fa-fw'></i>Viajes</a>
                                </li>
                                  <li>
                                    <a href="#"><i class='fa fa-list-ol fa-fw'></i>Paquetes</a>
                                </li>
                            </ul>
                        </li>
